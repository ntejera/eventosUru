...
<html lang="es">
    ...
    <body >
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="carousel slide" id="carousel-208896">
                        <ol class="carousel-indicators">
                            <li data-slide-to="0" data-target="#carousel-208896" class="active">
                            </li>
                            <li data-slide-to="1" data-target="#carousel-208896">
                            </li>
                            <li data-slide-to="2" data-target="#carousel-208896">
                            </li>
                            <li data-slide-to="3" data-target="#carousel-208896">
                            </li>
                            <li data-slide-to="4" data-target="#carousel-208896">
                            </li>
                        </ol>
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" alt="Carousel Bootstrap First" src="../ProyectoEventos/imagenes/01-11-2018 valdivieso imagen .jpg" />
                                ...
                                <div class="carousel-caption">
                                    ...
                                    <p>
                                        Encontrá las mejores actividades para hacer gratuitamente.
                                    </p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" alt="Carousel Bootstrap Second" src="../ProyectoEventos/imagenes/Teatro-Colon-mejores-mundo_1882331800_4917587_1300x731.jpg" />
                                <div class="carousel-caption">
                                    <h4>
                            ...
                            <div class="carousel-item">
                                <img class="d-block w-100" alt="Carousel Bootstrap Third" src="../ProyectoEventos/imagenes/1536072952-sssss.jpg" />
                                <div class="carousel-caption">
                                    <h4>
                            ...
                            <div class="carousel-item">
                                <img class="d-block w-100" alt="Carousel Bootstrap Fourd" src="../ProyectoEventos/imagenes/" />
                                <div class="carousel-caption">
                                    <h4>
                                        Third Thumbnail label
                                    </h4>
                            ...
                            <div class="carousel-item">
                                <img class="d-block w-100" alt="Carousel Bootstrap Fifth" src="../ProyectoEventos/imagenes/Venta de obras de arte en medellin pinturas.webp" />
                                <div class="carousel-caption">
                                    <h4>
                                        Third Thumbnail label
                                    </h4>
                        ...
                        </div> <a class="carousel-control-prev" href="#carousel-208896" data-slide="prev"><span class="carousel-control-prev-icon"></span> <span class="sr-only">Previous</span></a> <a class="carousel-control-next" href="#carousel-208896" data-slide="next"><span class="carousel-control-next-icon"></span> <span class="sr-only">Next</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!--<div class="header">
            ...
            <br>
            <h1 >Eventos Gratis</h1> <br>
            <h2 ><strong>Disfruta los mejores eventos gratuitos</strong>  </h4>
            <hr>
        ...
        <div class="nav">
            <div class="container">
                ...
                <ul>
                    ...
                    <li><b> <a href="www.eventosgratis.com/calendario" > Calendario</a> </b></li> 
                    <li><b><a href="www.eventosgratis.com/musica" >Música</a> </b></li>
                    <li><b><a href="www.eventosgratis.com/teatro"  >Teatro</a></b> </li>
                    <li><b><a href="www.eventosgratis.com/cine" >Cine</a> </b></li>
                    <li><b><a href="www.eventosgratis.com/arte" >Arte</a></b> </li>
                    <li><b><a href="www.eventosgratis.com/internacional">Internacional</a></b> </li>
                    <li><b><a href="www.eventosgratis.com/cienciaytec" >Ciencia y tecnología</a></b> </li>
                    <li><b><a href="www.eventosgratis.com/festivales"  >Festivales</a> </b></li>
                    <li><b><a href="www.eventosgratis.com/ninos" >Niños</a> </b></li>
                    <li><b><a href="www.eventosgratis.com/otros"  >Otros</a> </b></li>
                    <li title="Encontra tu evento"><b><a href="www.eventosgratis.com/buscador"  >Buscar</a></b></li>
                </ul>
            </div>
        </div>
        <br>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <h5 class="card-title">
                                        Acá un evento                  </h5>
                                    <p class="card-text">
                                        aca la descripcion del evento. lalalal lalala lalala lalala lalala lalalala lalalal alalala lalala lala                    </p>
                                    </p>
                                    <p>
                                        <a class="btn btn-primary" href="#">Leer más</a> <a class="btn" href="#">Ir a Calendario</a>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <!--
            ...
            <div class="main">
                ...
                <h4>Acá un evento</h4>
                <br>
                <p>aca la descripcion del evento. lalalal lalala lalala lalala lalala lalalala lalalal alalala lalala lala lalal la laal al al la.</p>
                <br>
                <br>
                <h4>Aca otro evento</h4>
                <br>
                <p>la descripcion del otro evento. lalalalalalallalalalalalalalla lalalalal lalalala lalalala lalalalal lalalala.</p>
                <br>
                </div>
            </div>
